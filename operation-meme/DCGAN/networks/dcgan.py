...
class Generator(chainer.Chain):
	...
	def __init__(self):
		super(Generator, self).__init__(
			l1=L.Linear(100,1024*4*4),
            dcv1=L.Deconvolution2D(in_channels=1024,out_channels=512,ksize=4,stride=2,pad=1),
            ...
            bc1=L.BatchNormalization(size=1024),
	...
	def __call__(self, x, train=True):
		...
		h4 = F.relu(self.bc4(self.dcv3(h3)))
		return self.dcv4(h4)
...
class Discriminator(chainer.Chain):
	...
	def __init__(self):
		super(Discriminator, self).__init__(
            ...
            conv4=L.Convolution2D(in_channels=512,out_channels=1024,ksize=5,stride=2,pad=2),
	...
	def __call__(self, x, train=True):
		...
		h4 = F.leaky_relu(self.bc4(self.conv4(h3)))
		return self.l1(h4)